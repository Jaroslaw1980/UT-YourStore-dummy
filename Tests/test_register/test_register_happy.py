...
from Selenium.UTYourStore.test_data.testdata import DataFeeder
...
class RegisterAccountTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.feeder = DataFeeder.data_feeder
    ...
    def test_firstname_input(self):
        ...
        self.firstname = RegisterAccountTest.feeder('B3')
    ...
    def test_lastname_input(self):
        ...
        log = RegisterAccountTest.logger
        self.lastname = RegisterAccountTest.feeder('C3')
    ...
    def test_email_input(self):
        ...
        log = RegisterAccountTest.logger
        self.email = RegisterAccountTest.feeder('D3')
    ...
    def test_telephone_input(self):
        ...
        log = RegisterAccountTest.logger
        self.telephone = RegisterAccountTest.feeder('E3')

        RegisterAccountTest.register.input_telephone(self.telephone)
        RegisterAccountTest.logger.info(f'Inputed telephone: {self.telephone}')
        assert 3 < (len(str(self.telephone))) < 32, log.info('Telephone must be between 3 and 32 characters!')

    def test_passwordconfirm_input(self):

        log = RegisterAccountTest.logger
        self.password = RegisterAccountTest.feeder('F3')
    ...
    def test_password_input(self):
        ...
        log = RegisterAccountTest.logger
        self.confirm_password = RegisterAccountTest.feeder('G3')
